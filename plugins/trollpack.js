...
╰────────────────╯`
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(web.data), MessageType.image, {mimetype: Mimetype.jpg , caption: Config.ALL})
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(web.data), MessageType.image, {mimetype: Mimetype.png , caption: Config.ALL})
